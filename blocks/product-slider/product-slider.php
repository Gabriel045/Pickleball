        ...
        <div id="multiple-items" class="product-slider mt-[60px] flex ">
            ...
            ?>
                <article <?php if ($coming_soon) echo 'data-id="' . $item->ID . '" data-coming-soon="true"'; ?>
                    class="!flex flex-col gap-[5px] lg:max-w-[350px] !h-auto">
                    <figure>
                        <a href="<?php echo get_permalink($item->ID); ?>">
                            <img loading="lazy" class="aspect-[0.8] object-cover w-full rounded-lg"
                 ...
                 <div class="flex flex-col gap-[6px]">
                            ...
                            <div class="text-gray-paragraph text-[16px] leading-[18px]">
                                <?php echo $product->get_short_description(); ?> </div>
