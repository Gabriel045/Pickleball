...
<section id="three-cols" class="">
    <div class="block_content ">
        <div class="flex">
            ...
            <div class="w-1/3 py-[80px] px-[60px]"
                ...
                <div
                    class="text-white [_&_li]:flex [_&_li]:items-center [_&_li]:mb-[20px] [_&_p]:leading-[28px]  [_&_p]:text-[16px] [_&_h3]:text-[30px] [_&_h3]:font-semibold">
