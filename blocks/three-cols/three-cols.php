...
<section id="three-cols" class="">
    <div class="w-full pt-16">
        <div class="flex flex-wrap lg:flex-nowrap ">
            ...
            <div class="w-full py-[60px] lg:py-[80px] px-[30px] lg:px-[60px]  !bg-cover"
                style="background:linear-gradient(0deg,rgba(5, 5, 5, 1) 0%, rgba(39, 39, 40, 0.79) 67%, rgba(116, 116, 120, 0.46) 90%), url(<?php echo $col["image"] ?>);">
                <div
