...
<body <?php body_class(); ?>>
    ...
    <header class="relative overflow-x-clip">
        ...
        <div class="block_content m-auto flex justify-between w-full px-[30px] lg:px-[50px] py-4">
            <div class="flex lg:gap-4 xl:gap-10 items-center w-[70%] md:w-[82%]">
                ...
                <div class="hidden lg:block">
                    <div class="menu_header">
                        ...
                        wp_nav_menu(array(
                            'menu'   => 'Header menu',
                            'menu_class' => 'menu_header flex xl:gap-[10px] block_content m-auto',
                            'container' => false,
                        ));
                        ?>
                    </div>
                </div>
                <form role="search" method="get" class="hidden lg:flex search-form  w-[30%] relative"
            ...
            <!-- Desktop -->
            <div class="hidden lg:flex gap-3 xl:gap-6 items-center lg:w-[18%] w-full lg:justify-end  ">
                <a href="/my-account">
                    <svg class="" xmlns="http://www.w3.org/2000/svg" width="23" height="22" viewBox="0 0 23 22"
                        fill="none">
                        <path
                ...
                <a href="/cart" class="btn-primary">
                    <svg class="xl:w-5 lg:w-4" xmlns="http://www.w3.org/2000/svg" width="22" height="22"
