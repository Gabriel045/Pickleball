...
?>
<div id="slide-cart"
    class="w-full md:w-[500px] h-[100vh]  overflow-y-auto  pt-[50px] fixed z-[99999999] bg-white right-0 translate-x-[800px] top-[0px] rounded-lg">
    <div class="relative">
        <div class="flex justify-between items-center mb-[20px] px-[20px] lg:px-[40px]">
