...
<div class="u-columns col2-set py-[40px] lg:py-[80px] px-[30px] lg:px-[60px]" id="customer_login">

    <div class="u-column1 col-1">

        <?php endif; ?>

        <h2 class="text-center text-[24px] font-[600] text-rich-black"><?php esc_html_e('Login', 'woocommerce'); ?>
        </h2>
    ...
    <div class="u-column2 col-2">
        ...
        <h2 class="text-center text-[24px] font-[600] text-rich-black"><?php esc_html_e('Register', 'woocommerce'); ?>
        </h2>
