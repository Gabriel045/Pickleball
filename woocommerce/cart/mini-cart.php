...
<?php if (WC()->cart && ! WC()->cart->is_empty()) : ?>
    ...
    <?php if ($_POST["page"] != "checkout") : ?>
        ...
        <div class="more-recommended bg-[#FAFBFC] px-[40px] py-[40px] mt-[50px]">
	...
	<p class="woocommerce-mini-cart__total total">
        ...
        <div class="checkout-btn woocommerce-mini-cart__buttons buttons pt-[40px] px-[40px] ">
