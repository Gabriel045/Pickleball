...
<main id="shop">
    <section id="">
        <div class="block_content py-[50px] px-[30px] lg:px-[60px]">
            <div class="flex flex-wrap lg:flex-nowrap lg:gap-[80px]">
                <div class="w-full lg:w-[65%]">
                    <div class="subheader">
                        <div class="flex justify-between">
                            <div class="flex items-center gap-[10px]">
                                ...
                                <?php if (!empty(get_field('read_time', $post->ID))) : ?>
                                    <span
                                        class="text-sm font-semibold text-[#47546799] flex justify-center items-center">•</span>
                                    <p class="text-sm font-semibold text-[#47546799]">
                                        Read Time:
                                        <?php echo  get_field('read_time', $post->ID) ?>
                                    </p>
                                <?php endif; ?>
                    ...
                    <div
                        class="text-gray-paragraph text-[16px] lg:text-[18px] leading-[28px] [_&_hr]:my-[24px]
                           ...
                           [_&_h2]:text-black [_&_h2]:text-[36px]  [_&_h2]:font-semibold  [_&_h2]:leading-[45px] [_&_h2]:my-[20px]
                             [_&_p]:pb-[15px] [_&_li]:pb-[10px] [_&_img]:rounded-[12px] [_&_img]:mb-[40px] [_&_img]:mt-[20px] [_&_figcaption]:mt-[-30px]">
                        <?php the_content(); ?>
                    </div>
                    <div class="conclution p-[32px] rounded-[32px] bg-[#FAFBFC] mt-12  text-[16px] 
                        lg:text-[18px] text-gray-paragraph leading-[28px]
                            ...
                            <?php foreach ($random_blogs as $key => $card) : ?>
                                <article>
                                    ...
                                    <div class="mt-2 flex gap-3">
                                        ...
                                        <?php if (!empty(get_field('read_time', $card->ID))) : ?>
                                            <span
                                                class="text-xs font-semibold text-[#47546799] flex justify-center items-center">•</span>
                                            <p class="text-xs font-semibold text-[#47546799]">
                                                Read Time:
                                                <?php echo get_field('read_time', $card->ID) ?>
                                            </p>
                                        <?php endif; ?>
                                    </div>
                                    <div class="flex justify-between">
                                    ...
                                    <article class="">
                                        ...
                                        <div class="mt-[24px]">
                                            <div class="flex items-center gap-[10px]">
                                                ...
                                                <span
                                                    class="text-[14px] text-[rgba(71,84,103,0.60)] font-medium leading-[24px]">5.0
                                                    (59
                                                    Reviews)</span>
                                            </div>
